...
define apache::vhost(
  ...
  $ssl_proxy_ssl_ca            = undef,
  $ssl_proxy_certs_dir         = undef,
  $ssl_proxy_crl_check         = undef,
  $ssl_proxy_crl               = undef,
  $ssl_proxy_crl_path          = undef,
  $ssl_proxy_checkpeercn       = undef,
  $ssl_proxy_checkpeerexpire   = undef,
  $ssl_proxy_checkpeername     = undef,
  $ssl_proxy_cipher            = undef,
  $ssl_proxy_mc_chain_file     = undef,
  $ssl_proxy_mc_path           = undef,
